...
class DbMock:
    ...
    def get_vfp_of_included_text_files(self, root_uid, blacklist=None):
        if root_uid == '34d7e9d95a3896f445e438037e5d03c98b4b5097b14c8c5521eb83105c569709_61':
            return {'/firmware1/example.config': {'uid_1'},}
        if root_uid == '6bcbfafd4affeb5d5657653566c06420e5961d9712f5b5774094ce0c5f2763c7_61':
            return {'/firmware2/example.config': {'uid_2'}}
        return {}
